...
2. Use `nodesify-graphify query`, `nodesify-graphify explain`, or `nodesify-graphify path` instead of searching files directly for codebase questions
