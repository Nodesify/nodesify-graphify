...
exports.affectedCommand = affectedCommand;
const native_1 = require("../native");
async function affectedCommand(node, opts) {
    try {
        const depth = parseInt(opts.depth, 10) || 2;
        const result = (0, native_1.affectedNode)(opts.graph, node, depth, opts.relation);
        if (result.total === 0) {
